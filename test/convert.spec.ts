import { convertMdText } from "../src/convertMdTree";
...
describe("heading convert", () => {
  it("heading1", () => {
    ...
    const result = convertMdText(text).replace(/\n/g, "");
...
describe("codeblock", () => {
  it("Not language & Not filename", () => {
    ...
    const result = convertMdText(codeblockData).replace(/\n/g, "");
    expect(result).toEqual(convertedResult);
  });
  ...
  it("language txt & Not filename", () => {
    ...
    const result = convertMdText(codeblockTxt).replace(/\n/g, "");
    expect(result).toEqual(convertedResult);
  });
  ...
  it("language js & Not filename", () => {
    ...
    const result = convertMdText(codeblockJs).replace(/\n/g, "");
    expect(result).toEqual(convertedResult);
  });

  it("pre-line", () => {
    const result = convertMdText(codeblockBr);
...
describe("table", () => {
  ...
  it("inline column", () => {
    ...
    const result = convertMdText(text2).replace(/\n/g, "");
    expect(result).toEqual(convertedResult);
  });
});
...
describe("colorBlock", () => {
  it("default", () => {
    const result = convertMdText(default_block);
  ...
  it("info", () => {
    const result = convertMdText(info_block);
  ...
  it("success", () => {
    const result = convertMdText(success_block);
  ...
  it("warning", () => {
    const result = convertMdText(warning_block);
  ...
  it("danger", () => {
    const result = convertMdText(danger_block);
...
it("html", () => {
  const result = convertMdText("<span>aaa</span>");
  const convertResult = `<span class="span"><span>aaa</span></span>\n`;
  expect(result).toEqual(convertResult);
})

it("html empty", () => {
  const result = convertMdText("<");
